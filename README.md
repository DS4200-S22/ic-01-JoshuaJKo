...
1. Open index.html in your favorite text editor (if you do not have a favorite, we recommend the free version of [Sublime Text](https://www.sublimetext.com/)) and replace Joshua Ko with your name. 

1. Push your change to your remote repo. 

1. Create a GitHub Page for your repo. 

1. Add the link to your GitHub Page https://github.ccs.neu.edu/joshuajko/joshuajko.github.io 
